...
function Card(props) {
  ...
  const cardLikeButtonClassName = (`button button_type_like opacity ${isLiked ? 'button_type_like_active' : ''}`)
    ...
    <li className="card"> 
      ...
      <div className="card__content">
        ...
        <div className="card__like-block">
          <button className={cardLikeButtonClassName} aria-label="Нравиться" type="button"></button>
